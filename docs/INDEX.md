...
This index keeps the full documentation map while the README stays focused on the top five entry points.
...
- [docs/platform/AI_INSIGHT_BOUNDARY.md](platform/AI_INSIGHT_BOUNDARY.md)
...
## Rules and Pattern Contract

- [docs/rules/PATTERN_CONTRACT.md](rules/PATTERN_CONTRACT.md)
- [docs/rules/RULE_AUTHORING_GUIDE.md](rules/RULE_AUTHORING_GUIDE.md)

## Release and Announcement

- [docs/release/RELEASE_NOTES_v0.1.0.md](release/RELEASE_NOTES_v0.1.0.md)
- [docs/release/ANNOUNCEMENT_LONG_zh.md](release/ANNOUNCEMENT_LONG_zh.md)
- [docs/release/ANNOUNCEMENT_SHORT_zh.md](release/ANNOUNCEMENT_SHORT_zh.md)
...
- [docs/assets/ASSET_INDEX.md](assets/ASSET_INDEX.md)
- [docs/assets/demo/demo-outputs.md](assets/demo/demo-outputs.md)
- [docs/assets/demo/product-flow.md](assets/demo/product-flow.md)
- [docs/assets/screenshots/CAPTURE_PLAN.md](assets/screenshots/CAPTURE_PLAN.md)
- [docs/assets/screenshots/MANUAL_CAPTURE_CHECKLIST.md](assets/screenshots/MANUAL_CAPTURE_CHECKLIST.md)

## Quality and OSS Prep

- [docs/TESTING_AND_GATES.md](TESTING_AND_GATES.md)
