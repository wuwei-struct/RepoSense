...
class L2DockerExtractTest(unittest.TestCase):
    def test_docker_l2_findings(self):
        rd = run_scan(fixture_path("repos", "docker"), out_dir(), ruleset_dir(), budget_path())
        ...
        self.assertIn("External IO", concepts)
        self.assertIn("Secrets/Config", concepts)
